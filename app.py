...
if st.button("🔍 종목 스캔 시작", type="primary"):
    ...
    base_cols = [
        "name", "code", "sector", "close", "ma5", "ma20", "rsi",
        "vol_ratio", "pullback", "trade_type", "buy_zone",
        "stop_loss", "strategy", "reason", "chart", "news", "marcap"
    ]

    watch_cols = [
        "name", "code", "sector", "original_grade", "close", "ma5", "ma20",
